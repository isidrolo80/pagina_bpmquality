...
$secretKey = "MYSECRETKEY"; //secret key for google recaptcha
$ip = $_SERVER['My server'];
...
try {
    ...
    //Recipients
    $mail->setFrom('my@email.com', 'BPM Quality At Pilisimas');
    ...
    $mail->addReplyTo('my@email.com', 'Información');
